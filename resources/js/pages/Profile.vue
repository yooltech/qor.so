        ...
        <div class="space-y-6">
          ...
          <div class="space-y-1.5">
            ...
            <div class="relative group">
              <Mail class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground transition-colors" />
              <input
                type="email"
                v-model="form.email"
                readonly
                class="w-full pl-11 pr-4 py-3.5 rounded-xl border bg-secondary/50 text-muted-foreground focus:outline-none transition-all text-sm font-mono cursor-not-allowed"
              />
            </div>
            <div class="mt-3 border border-primary/20 bg-primary/5 p-4 rounded-xl flex gap-3">
              <ShieldAlert class="h-4 w-4 text-primary shrink-0 mt-0.5" />
              <p class="text-[11px] text-muted-foreground leading-relaxed">
                This email is your <strong class="text-primary">secure login identity</strong>. It cannot be changed to ensure your account remains safe and your data accessible.
              </p>
            </div>
          </div>
